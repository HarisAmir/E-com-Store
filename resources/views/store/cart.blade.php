...
<!--                            -->
                    ...
                    <div class="order-col">
                        ...
                        <div ><strong class="order-total" id="totalCost">{{Session::get('price')}} PKR</strong></div>
                    </div>
                    @else
                    <div class="order-col">
                ...
                <div class="payment-method">
                    <div class="input-radio">
                        ...
                        <div class="caption">
                            <p>Only Cash on delivery acceptable</p>
                        </div>
                    </div>
                </div>
                @if(session('user'))
...
<script>
   ...
   //TO DO: ajax will take place
    ...
    $.ajax({
            ...
            {
                document.getElementById("individualPrice_"+order_serial).innerHTML=x*product_price+" PKR";
                document.getElementById("totalCost").innerHTML = msg[2]+" PKR";
            }
            });
